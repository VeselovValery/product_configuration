"""
Django settings for product_configuration project.
...
from core.env_utils import env_settings

# Build paths inside the project like this: BASE_DIR / 'subdir'.
BASE_DIR = os.path.dirname(os.path.dirname(os.path.abspath(__file__)))
TEMPLATES_DIR = os.path.join(BASE_DIR, 'templates')

LOGIN_REDIRECT_URL = 'configuration:index'
...
ROOT_URLCONF = 'product_configuration.urls'
...
WSGI_APPLICATION = 'product_configuration.wsgi.application'
